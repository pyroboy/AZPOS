...
export const paymentMethodConfigSchema = z.object({
  id: z.string(),
  type: z.enum(['cash', 'card', 'digital_wallet', 'bank_transfer', 'store_credit', 'gift_card', 'check', 'crypto']),
  name: z.string(),
...
export const paymentProcessingSchema = z.object({
  ...
  payment_method_type: z.enum(['cash', 'card', 'digital_wallet', 'bank_transfer', 'store_credit', 'gift_card', 'check', 'crypto']),
...
export const paymentTerminalSchema = z.object({
  ...
  supported_methods: z.array(z.enum(['cash', 'card', 'digital_wallet', 'bank_transfer', 'store_credit', 'gift_card', 'check', 'crypto'])),
  settings: z.object({
...
export const paymentStatsSchema = z.object({
  ...
  payment_method_breakdown: z.record(z.string(), z.object({
    count: z.number(),
    total_amount: z.number(),
    percentage: z.number(),
    avg_amount: z.number()
  })),
  hourly_volume: z.array(z.object({
    hour: z.number(),
...
export const paymentFiltersSchema = z.object({
  ...
  status: z.enum(['all', 'pending', 'processing', 'completed', 'failed', 'cancelled', 'refunded']).optional(),
  payment_method_type: z.enum(['cash', 'card', 'digital_wallet', 'bank_transfer', 'store_credit', 'gift_card', 'check', 'crypto']).optional(),
