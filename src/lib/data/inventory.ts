...
const inventoryQueryKeys = {
  ...
  movementsList: (productId?: string, locationId?: string) => [...inventoryQueryKeys.movements(), productId, locationId] as const,
...
export function useInventory(filters?: InventoryFilters) {
  ...
  return {
    ...
    refetchValuation: () => queryClient.invalidateQueries({ queryKey: inventoryQueryKeys.valuation() }),
...
export function useOptimisticInventoryUpdate() {
  ...
  return {
    ...
    updateQuantityOptimistic: (productId: string, locationId: string | undefined, newQuantity: number) => {
